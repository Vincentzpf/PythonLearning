...
- $pyenv install 3.5.3
- $pyenv versions
- pyenv global system '是作用于非root用户python用户上。
- pyenv shell 3.5.3 '影响只是作用于当前会话。
- pyenv local 3.5.3 '设备从当前工作目录开始向下递归都继承这个设置。

参考地址：（Python多版本切换工具-Pyenv\virtualenv及Anaconda科学计算环境的配置）
